...
#	SELL_ORDER_IDENTIFIERS = []
	...
	TYPE_BUYER = CrossProduct(TypeCheck(tBuyOrderId), tNatural, tNumber, tNatural)
	TYPE_SELLER = CrossProduct(TypeCheck(tSellOrderId), tNatural, tNumber, tNatural)
	...
	petriNet = PetriNet('0_specification_model')
...
#	petriNet.draw("model_aist_A_deviation_control_flow.png")
