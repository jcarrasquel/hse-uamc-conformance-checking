...
public class OrderEvent extends Event implements Comparable<OrderEvent>{
	...
	public OrderEvent(String activity, String state, String timestamp, String price, String side, String qty, String receiver, String ciOrderId, String securityId) throws ParseException {
	...
	public OrderEvent(String activity, String state, String timestamp, String price, String side, String qty, String receiver, String ciOrderId, String orderType, String securityId) throws ParseException {
		super(activity, timestamp);
		if(state != null){
			this.setState(state);
		}else{
